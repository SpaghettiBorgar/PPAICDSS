...
def test_xray_model(checkpoint, num_samples=64, res: int | None = 600, crop: bool = True, device="cuda"):
	...
	dataset = XrayDataset(offset=200000, use_chunks=False, transform=transform)
...
if __name__ == '__main__':
	args = parse_args()
	test_xray_model(args.checkpoint, num_samples=args.num_samples, res=args.resolution, crop=args.crop, device=args.device)
